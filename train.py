...
model.add(Conv2D(12, (5, 5), padding='valid', activation='elu'))
model.add(MaxPooling2D())
model.add(Dropout(rate=0.1))
model.add(Conv2D(18, (5, 5), padding='valid', activation='elu'))
model.add(MaxPooling2D())
model.add(Dropout(rate=0.1))
model.add(Conv2D(24, (5, 5), padding='valid', activation='elu'))
model.add(MaxPooling2D())
model.add(Dropout(rate=0.1))
...
model.fit(X_train, Y_train, validation_split=0.4, shuffle=True, epochs=4)
print(model_name)
